...
ruta_get = url + "estudiantes?apellido=Pérez"
get_response = requests.request(method="GET", url=ruta_get)
print(get_response.text)

ruta_get = url + "estudiantes?carrera=IngenieríaAgronomica"
get_response = requests.request(method="GET", url=ruta_get)
print(get_response.text)

print("******////////////// ***** **** **** ****")

ruta_get = url + "estudiantes?apellido=Pérez&carrera=IngenieríaAgronomica"
get_response = requests.request(method="GET", url=ruta_get)
print(get_response.text)
